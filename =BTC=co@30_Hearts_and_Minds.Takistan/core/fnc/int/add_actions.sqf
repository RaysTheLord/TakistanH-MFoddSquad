...
[toc_laptop, 0, ["ACE_MainActions"], _action] call ace_interact_menu_fnc_addActionToObject;
...
[toc_laptop, 0, ["ACE_MainActions", "side_mission"], _action] call ace_interact_menu_fnc_addActionToObject;
