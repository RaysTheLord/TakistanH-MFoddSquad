...
if (isServer) then {
    ...
    //TAGS
    btc_type_tags = ["Land_Graffiti_01_F", "Land_Graffiti_03_F"];
...
//FOB
btc_fob_mat = "Land_Cargo20_military_green_F";
btc_fob_structure = "Land_Cargo_HQ_V3_F";
btc_fob_flag = "FODDSQUADflag_v2";
btc_fob_id = 0;
...
//Containers
btc_containers_mat = ["Land_Cargo20_sand_F", "Land_Cargo40_sand_F"];
...
_allclasse = [["CFP_O_ALQAEDA", "CUP_O_TK_MILITIA", "CFP_O_TBAN", "CFP_O_IS"], _p_en_AA, _p_en_tank] call btc_mil_fnc_class; //Create classes from factions, you can combine factions like that: [[_p_en , "IND_F"], _p_en_AA, _p_en_tank] call btc_mil_fnc_class;
